...
translate russian strings:
    ...
    # game/scripts/language_picker.rpy:18
    old "English"
    new "Английский"

    # game/scripts/language_picker.rpy:19
    old "Русский"
    new "Русский"
...
translate russian strings:
    ...
    # renpy/common/00accessibility.rpy:29
    old "Clipboard voicing enabled. "
    new "Озвучивание из буфера обмена включено."
    ...
    old "Self-Voicing Volume Drop"
    new "Затухание громкости при самоозвучивании"

    # renpy/common/00accessibility.rpy:234
    old "The options on this menu are intended to improve accessibility. They may not work with all games, and some combinations of options may render the game unplayable. This is not an issue with the game or engine. For the best results when changing fonts, try to keep the text size the same as it originally was."
    new "Параметры в этом меню предназначены для улучшения доступности. Они могут работать не со всеми играми, а некоторые комбинации параметров могут сделать игру неиграбельной. Это не является проблемой игры или движка. Для достижения наилучших результатов при изменении шрифтов старайтесь, чтобы размер текста оставался таким же, как и в оригинале."
    ...
    # renpy/common/00gui.rpy:456
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "Это сохранение было создано на другом устройстве. Вредоносные файлы сохранения могут повредить ваш компьютер. Вы доверяете создателю этого сохранения и всем, кто мог изменить файл?"

    # renpy/common/00gui.rpy:457
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "Вы доверяете устройству, на котором было создано сохранение? Вы должны выбирать «да» только в том случае, если вы единственный пользователь устройства."
    ...
    old "This program contains free software under a number of licenses, including the MIT License and GNU Lesser General Public License. A complete list of software, including links to full source code, can be found {a=https://www.renpy.org/l/license}here{/a}."
    new "Эта программа содержит бесплатное программное обеспечение под рядом лицензий, включая лицензию MIT и GNU Lesser General Public License. Полный список программного обеспечения, включая ссылки на полный исходный код, можно найти {a=https://www.renpy.org/l/license}здесь{/a}."
    ...
    old "self voicing volume drop"
    new "падение громкости самоозвучивания"

    # renpy/common/00preferences.rpy:427
    old "clipboard voicing"
    new "озвучивание из буфера обмена"
    ...
    # renpy/common/00preferences.rpy:519
    old "audio when minimized"
    new "аудио при сворачивании"

    # renpy/common/00preferences.rpy:528
    old "audio when unfocused"
    new "аудио без фокуса"
    ...
    old "Clipboard voicing enabled. Press 'shift+C' to disable."
    new "Озвучивание из буфера обмена включено. Нажмите 'shift+C', чтобы отключить."

    # renpy/common/00preferences.rpy:655
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "Самоозвучивание скажет \"[renpy.display.tts.last]\". Нажмите 'alt+shift+V', чтобы отключить."
    ...
    old "The Ren'Py Sync server does not have a copy of this sync. The sync ID may be invalid, or it may have timed out."
    new "На сервере Ren'Py Sync нет копии этой синхронизации. Идентификатор синхронизации может быть недействительным, или время его действия истекло."

    # renpy/common/00sync.rpy:412
    old "Please enter the sync ID you generated.\nNever enter a sync ID you didn't create yourself."
    new "Пожалуйста, введите созданный вами идентификатор синхронизации.\nНикогда не вводите идентификатор синхронизации, который вы не создавали сами."

    # renpy/common/00sync.rpy:431
    old "The sync ID is not in the correct format."
    new "Идентификатор синхронизации имеет неверный формат."
    ...
    old "This will contact the {a=https://sync.renpy.org}Ren'Py Sync Server{/a}."
    new "Это свяжется с {a=https://sync.renpy.org}сервером Ren'Py Sync{/a}."
    ...
    old "Either this project does not support updating, or the update status file was deleted."
    new "Либо этот проект не поддерживает обновление, либо файл статуса обновления был удален."
    ...
    old "The update file does not have the correct digest - it may have been corrupted."
    new "Файл обновления имеет неверную контрольную сумму - возможно, он был поврежден."
    ...
    old "[u.version] is available. Do you want to install it?"
    new "[u.version] доступно. Вы хотите установить его?"
    ...
    new "Принудительный GL рендерер"

    # renpy/common/00gltest.rpy:105
    old "Force ANGLE Renderer"
    new "Принудительный ANGLE рендерер"

    # renpy/common/00gltest.rpy:110
    old "Force GLES Renderer"
    new "Принудительный GLES рендерер"

    # renpy/common/00gltest.rpy:116
    old "Force GL2 Renderer"
    new "Принудительный GL2 рендерер"

    # renpy/common/00gltest.rpy:121
    old "Force ANGLE2 Renderer"
    new "Принудительный ANGLE2 рендерер"

    # renpy/common/00gltest.rpy:126
    old "Force GLES2 Renderer"
    new "Принудительный GLES2 рендерер"
    ...
    old "This game requires use of GL2 that can't be initialised."
    new "Этой игре требуется использование GL2, который не может быть инициализирован."
    ...
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Его графические драйверы могут быть устаревшими или работать неправильно. Это может привести к медленному или неправильному отображению графики."
    ...
    old "Continue, Don't show warning again"
    new "Продолжить, больше не показывать это предупреждение"
    ...
    old "Copies the traceback.txt file to the clipboard as BBcode for forums like https://lemmasoft.renai.us/."
    new "Копирует файл traceback.txt в буфер обмена в виде BBcode для форумов, таких как https://lemmasoft.renai.us/."
    ...
    old "Copies the traceback.txt file to the clipboard as Markdown for Discord."
    new "Копирует файл traceback.txt в буфер обмена в виде Markdown для Discord."
    ...
    old "Attempts a roll back to a prior time, allowing you to save or choose a different choice."
    new "Пытается откатиться к предыдущему моменту, позволяя вам сохранить или выбрать другой вариант."
