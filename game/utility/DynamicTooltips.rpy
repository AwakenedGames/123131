init python:
    ...
    class HoverTooltip(renpy.Displayable):
        ...
        def __init__(self, text_size: int = 15, text_style: str = "default", padding: int = 10, spacing: int = 5, bg: str = "gui/RoundedTooltip.webp", text_xmax: int = 150, img_xmax: int = 150, **kwargs):
