...
#         def __init__(self, child, randomkey=NotSet, chroma=True, minbandheight=1, offset=30, nslices=None, *args, **properties):
#             super(glitch, self).__init__(**properties)
...
#         def __init__(self, timeout_base=None, timeout_vanilla=None, *args, **kwargs):
#             super(animated_glitch, self).__init__(*args, **kwargs)
...
#         def __init__(self, child, randomkey=NotSet, *args, **kwargs):
#             super(squares_glitch, self).__init__()
#             self.child = renpy.displayable(child)
#             self.args = args
#             if randomkey is self.NotSet:
#                 randomkey = renpy.random.random()
